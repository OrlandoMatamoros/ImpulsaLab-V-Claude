...
export default function RiskShieldSection() {
  ...
  return (
    <section className="relative animate-fadeIn">
      {/* Banner Superior - Mejorado para móviles */}
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 py-4 px-4 border-b-2 border-blue-200">
        <p className="text-center font-semibold text-gray-900 text-sm md:text-base">
          ¿Otro consejo gratis? 
          <span className="block md:inline md:ml-2 text-blue-700 font-bold">
      ...
      {/* Botón de WhatsApp - Posicionado para no interferir con el chatbot */}
      <a 
        href="https://wa.me/13479043196?text=Quiero%20agendar%20mi%20Diagnóstico%203D"
        className="fixed bottom-6 right-24 z-40 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-110"
        target="_blank"
        rel="noopener noreferrer"
        title="Ir directo a WhatsApp"
      >
